...
async function run() {
  ...
  try {
    ...
    console.log("Created booking, making API request to cancel via cancellationsApi...");
    
    const res = await fetch(`http://localhost:5001/api/cancellations/cancel-booking`, {
      method: 'POST',
      headers: {
