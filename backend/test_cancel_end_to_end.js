...
async function run() {
  ...
  try {
    ...
    console.log("Created booking, making API request to list bookings...");
    const resList = await fetch(`http://localhost:5001/api/bookings`, {
    ...
    console.log("Making API request to cancel...");
